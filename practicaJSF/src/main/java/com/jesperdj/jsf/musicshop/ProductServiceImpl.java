...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductServiceImpl() {
        ...
        map.put(6L, new Product(6L, "Producto del Curso 1", "Steal the show with this cool saxophone. Suitable for beginners as well as for advanced players.", new BigDecimal("1195.00"), "saxophone"));
        map.put(7L, new Product(7L, "Curso Producto 2", "Every band needs a solid bass guitar. This one will never let you down.", new BigDecimal("895.00"), "bassguitar"));
        map.put(8L, new Product(8L, "Kit de productos dle Curso", "This complete drum kit provides everything a drummer needs. Including an extra pair of sticks.", new BigDecimal("1249.00"), "drumkit"));
